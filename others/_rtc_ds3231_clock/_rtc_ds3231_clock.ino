...
void setup()
{
  ...
  int segH = 9; //Pino segmento H
  
  //Define o numero de digitos do display
  int numberOfDigits = 4;
 
  //Inicializa o display
  display7seg.Begin(displayType, numberOfDigits, digit1, digit2, digit3, digit4, segA, segB, segC, segD, segE, segF, segG, segH);
  
  //Nivel de brilho do display
  display7seg.SetBrightness(10);
  timer = millis();
}
